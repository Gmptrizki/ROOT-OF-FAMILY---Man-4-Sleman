...
<head>
    ...
    <title>{{ config('app.name', 'RootFamily') }}</title>
    ...
    <style>
        ...
        @layer theme {
            ...
            :host {
                ...
                --color-violet-700: oklch(.491 .270 292.581);
        ...
        @layer utilities {
            ...
            @starting-style {
                .starting\:translate-y-4 {
                    --tw-translate-y: calc(var(--spacing)*4; translate:var(--tw-translate-x)var(--tw-translate-y)
                    }
                }

                @starting-style {
                    .starting\:translate-y-6 {
                        --tw-translate-y:calc(var(--spacing)*6; translate:var(--tw-translate-x)var(--tw-translate-y)
                        }
                    }
                ...
                @keyframes bounce {
                    0%, to {
                        animation-timing-function:cubic-bezier(.8, 0, 1, 1; transform:translateY(-25%)
                        }

                        50% {
                            animation-timing-function:cubic-bezier(0, 0, .2, 1); transform:none
                        }
                    }
...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none flex flex-col justify-center">
                <!-- Judul utama dengan penekanan yang lebih baik -->
                <h1 class="mb-3 font-bold text-2xl lg:text-3xl text-[#1b1b18] dark:text-[#EDEDEC] tracking-tight">
                    Family Root - MAN 4 Sleman
                </h1>

                <!-- Tagline dengan styling yang lebih elegan -->
                <p
                    class="mb-6 text-[15px] lg:text-[16px] leading-relaxed text-[#706f6c] dark:text-[#A1A09A] italic border-l-4 border-[#f53003] dark:border-[#FF4433] pl-4 py-1">
                    "Menjaga Akar, Merajut Generasi"
                </p>
            </div>
            ...
            <div
                ...
                <!-- Gambar dengan overlay gradient untuk teks lebih readable -->
                <div
                    class="relative w-full h-full flex items-center justify-center transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-4">
                    <img src="{{ asset('images/background.png') }}" alt="Family Root MAN 4 Sleman"
