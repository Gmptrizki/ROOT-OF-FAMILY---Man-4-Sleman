...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-3xl w-full bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6">
            <form id="wizard-form" method="POST" action="{{ route('families.store.brother') }}">
                @csrf
                <div class="step" data-step="1">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h2 class="text-xl font-semibold text-gray-800">Data Saudara Laki-Laki</h2>
                            <p class="text-gray-600">Mulailah dengan mengisi data Saudara Laki-Laki Anda</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-700">Nama Lengkap Saudara Laki-Laki</label>
                                <input type="text" name="name"
                                    class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500"
                                    placeholder="Nama lengkap Saudara Laki-Laki" required>
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes"
                                class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500"
                                rows="2" placeholder="Tambahkan catatan tentang Saudara Laki-Laki"></textarea>
                        </div>
                    </div>
