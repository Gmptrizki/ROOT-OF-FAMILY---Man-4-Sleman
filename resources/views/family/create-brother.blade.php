<x-app-layout>
    <div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
        <h2 class="text-xl font-bold mb-4">Step 1: Tambah Saudara Laki-Laki</h2>

        <form action="{{ route('families.store.brother') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Lanjut ke Sister</button>
        </form>
    </div>
